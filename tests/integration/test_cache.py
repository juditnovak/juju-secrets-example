...
METADATA = yaml.safe_load(Path("./tests/integration/charms/cache-charm/metadata.yaml").read_text())
...
async def test_build_and_deploy(ops_test: OpsTest):
    ...
    charm = await ops_test.build_charm("./tests/integration/charms/cache-charm")
    resources = {
        "secrets-cache-charm-image": METADATA["resources"]["secrets-cache-charm-image"]["upstream-source"]
    }
